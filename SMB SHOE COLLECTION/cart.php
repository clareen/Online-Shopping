 ...
 $itemnumber=NULL;
	...
	while($row1 = mysql_fetch_array($rs1))
	 ...
	 if(isset($_REQUEST["update"]))
	  ...
	  echo "<td align='center'><font color=red align=center>". $row1['price'] . "</font></td>";	
	  $subtotal= $q*$row1['price'] ; 
	  echo "<td align='center'>UgShs: ".$subtotal."</td></tr><tr>";	
	  $total=$total+$subtotal;
...
<tr  ><td colspan="3" align="center" ><input align="right" type="submit" value="SUBMIT" /></td></tr>
</table>
...
<div id="footer">
<P align="center">© Copyright | 2018|  ~ All Rights Reserved</a>Claus</p>
