...
<img src="images/top-header.jpg" />
	...
	echo "<li><a href=ladies.php?itemnumber=0&rows=0&category=ladies&manufacturer=".$manufacturer. ">".$manufacturer."</a></li>";
...
if ($row['image']!=NULL)
	echo "<a href=details.php?itemnumber=".$row['itemnumber']." ><img align=center src=images/".$row['image']. " width='80' height='100'></img></a><br>";	  
	  	if ($row['price']>0)	 
	  echo "<font color=red align=center >Price:<br></font><b> UgShs ". $row['price'] . "</b><br>";	  
...
<div id="footer">
<P align="center">© Copyright | 2018 TI|  ~ All Rights Reserved</a></p>
